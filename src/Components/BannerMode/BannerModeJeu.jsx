                ...
                <div className='mode' id='modeDeJeux'>
                    ...
                    {showMoreMode2 && (
                        <>
                            ...
                            <ul>
                                <li className= 'listescardmode'>LGA est un jeu de rôle et d'exploration où les joueurs contrôlent leur héros et son équipe de monstres dans un monde ouvert et interactif. Les combats dans Evolve sont basés sur un système de combat au tour par tour, où les joueurs doivent utiliser la stratégie et la réflexion pour vaincre leurs ennemis.
